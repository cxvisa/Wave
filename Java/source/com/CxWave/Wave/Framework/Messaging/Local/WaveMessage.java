...
public class WaveMessage extends SerializableObject
{
    ...
    private UI32                         m_messageId                               = new UI32 (0);
    private UI32                         m_messageIdAtOriginatingLocation;
    public WaveServiceId                 m_senderServiceCode;
    private LocationId                   m_senderLocationId                        = FrameworkToolKit.getThisLocationId ();
    public LocationId                    m_receiverLocationId                      = FrameworkToolKit.getThisLocationId ();
    ...
    protected WaveMessage (final WaveServiceId serviceCode, final WaveOperationCodeInterface operationCode)
    {
        ...
        m_messageId.setValue (s_numberOfMessagesInTheSystemSoFar);
    ...
    public void setIsSynchronousMessage (final boolean isSynchronousMessage)
    {
    ...
    public void setSynchronizingMutex (final WaveMutex synchronizingMutex)
    {
    ...
    public void setSynchronizingCondition (final WaveCondition synchronizingCondition)
    {
    ...
    public void appendNestedSql (final String nestedSql)
    {
        m_nestedSql = m_nestedSql + nestedSql;
    }
    ...
    public void addXPathStringsVectorForTimestampUpdate (final Vector<String> xPathStringsVectorForTimestampUpdate)
    {
        m_xPathStringsVectorForTimestampUpdate.addAll (xPathStringsVectorForTimestampUpdate);
    }

    public void addXPathStringForTimestampUpdate (final String xPathString)
    {
        m_xPathStringsVectorForTimestampUpdate.add (xPathString);
    }
