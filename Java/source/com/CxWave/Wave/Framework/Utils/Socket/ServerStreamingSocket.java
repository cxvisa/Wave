...
public class ServerStreamingSocket implements StreamingSocket
{
    ...
    public AcceptedStreamingSocket accept ()
    {
        ...
        while (null == socket)
        {
            ...
            {
                WaveTraceUtils.tracePrintf (TraceLevel.TRACE_LEVEL_DEBUG, "Could not accept connection.  Host : %s and port : %d.", (m_serverSocket.getInetAddress ()).toString (), m_serverSocket.getLocalPort ());
