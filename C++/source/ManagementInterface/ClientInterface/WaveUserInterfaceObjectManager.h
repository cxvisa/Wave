...
class WaveUserInterfaceObjectManager : public WaveObjectManager
{
    ...
    public :
        ...
        static  ManagementInterfaceMessageHandlerForCStyleClient  getMessageHandlerForCStyleApplication              (const UI32 &operationCode);
                WaveMessageStatus                                 sendToWaveServer                                   (const UI32 &waveServerId, ManagementInterfaceMessage *pManagementInterfaceMessage, ManagementInterfaceMessageCallbackHandlerAtClient messageCallback, void *pInputContext = NULL, UI32 timeOutInMilliSeconds = 0, LocationId locationId = 0, WaveElement *pWaveMessageSender = NULL);
