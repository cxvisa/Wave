...
#ifndef PRISMTESTMANAGEDOBJECT4_H
#define PRISMTESTMANAGEDOBJECT4_H
...
class PrismTestManagedObject4 : public PrismTestManagedObject1
{
    private :
    ...
    public :
                                  PrismTestManagedObject4  (WaveObjectManager *pWaveObjectManager);
        virtual                  ~PrismTestManagedObject4  ();
        ...
        virtual bool              operator ==              (const PrismTestManagedObject4 &rhs) const;
        virtual bool              operator !=              (const PrismTestManagedObject4 &rhs) const;
...
#endif // PRISMTESTMANAGEDOBJECT4_H
