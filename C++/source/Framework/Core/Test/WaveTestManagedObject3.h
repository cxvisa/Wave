...
#ifndef WAVETESTMANAGEDOBJECT3_H
#define WAVETESTMANAGEDOBJECT3_H
...
class WaveTestManagedObject3 : public WaveTestManagedObject1
{
    private :
    ...
    protected :
    public :
                        WaveTestManagedObject3  (WaveObjectManager *pWaveObjectManager);
        virtual        ~WaveTestManagedObject3  ();
        ...
        virtual bool     operator ==             (const WaveTestManagedObject3 &rhs) const;
        virtual bool     operator !=             (const WaveTestManagedObject3 &rhs) const;
...
#endif // WAVETESTMANAGEDOBJECT3_H
