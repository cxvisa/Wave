...
WaveAsynchronousContextForShutDownPhases::WaveAsynchronousContextForShutDownPhases (PrismElement *pCaller, PrismAsynchronousCallback pCallback, void *pCallerContext)
