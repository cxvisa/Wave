...
WaveSendToClientsContext::WaveSendToClientsContext (WaveElement *pCaller, WaveAsynchronousCallback pCallback, void *pCallerContext, const string &clientName, bool isSubInstanceToBeIncluded)
