...
class WaveElement
{
    ...
    protected :
        ...
        virtual ResourceId                    querySynchronouslyForObjectIdForManagedObjectByName (const string &managedClassName, const string &nameValue, ObjectId &objectId, const string & = OrmRepository::getWaveCurrentSchema ())               = 0;
        ...
        virtual void                          listenForLightPulse                                 (const string &lightPulseName, WaveLightPulseHandler pWaveLightPulseHandler, WaveElement *pWaveElement = NULL) = 0;
