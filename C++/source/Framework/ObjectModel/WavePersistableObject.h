...
#ifndef WAVEPERSISTABLEOBJECT_H
#define WAVEPERSISTABLEOBJECT_H
...
class WavePersistableObject
{
    ...
    protected :
                     WavePersistableObject           (const string &objectClassName, const string &objectDerivedFromClassName);
                     WavePersistableObject           (const string &viewName);
