...
{
    waveAssert (AttributeType::AttributeTypeDate == (getAttributeType ()), __FILE__, __LINE__);
...
{
    waveAssert (AttributeType::AttributeTypeDateVector == (getAttributeType ()), __FILE__, __LINE__);
