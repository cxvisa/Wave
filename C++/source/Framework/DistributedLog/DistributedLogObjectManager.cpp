...
void DistributedLogObjectManager::initialize (WaveAsynchronousContextForBootPhases *pWaveAsynchronousContextForBootPhases)
{
    ...
    else
    {
        WaveSynchronousLinearSequencerStep sequencerSteps[] =
        {
            ...
            reinterpret_cast<WaveSynchronousLinearSequencerStep> (&DistributedLogObjectManager::waveSynchronousLinearSequencerSucceededStep),
...
void DistributedLogObjectManager::install (WaveAsynchronousContextForBootPhases *pWaveAsynchronousContextForBootPhases)
{
    ...
    WaveSynchronousLinearSequencerStep sequencerSteps[] =
    {
        reinterpret_cast<WaveSynchronousLinearSequencerStep> (&DistributedLogObjectManager::waveSynchronousLinearSequencerStartTransactionStep),
        ...
        reinterpret_cast<WaveSynchronousLinearSequencerStep> (&DistributedLogObjectManager::waveSynchronousLinearSequencerCommitTransactionStep),
        reinterpret_cast<WaveSynchronousLinearSequencerStep> (&DistributedLogObjectManager::waveSynchronousLinearSequencerSucceededStep),
        reinterpret_cast<WaveSynchronousLinearSequencerStep> (&DistributedLogObjectManager::waveSynchronousLinearSequencerFailedStep)
    };
...
ResourceId DistributedLogObjectManager::distributedLogAddLogEntryStep (DistributedLogSynchronousLinearSequencerContext *pDistributedLogSynchronousLinearSequencerContext)
{
    ...
    WaveServiceId                    waveServiceId                    = pDistributedLogAddLogEntryMessage->getWaveServiceId ();
    ...
    if (numberOfLogEntries < m_maxLogEntries)
    {
        ...
        pDistributedLogEntryManagedObject->setWaveServiceId (waveServiceId);
