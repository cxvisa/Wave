...
int main (int argc, char *argv[])
{
    ...
    Wave::registerClusterEnabledCheck (getIsClusterEnabled);

    Wave::enableAllFeatures ();

    return (isleMain (numberOfCommandLineArguments, pCommandLineArguments));
}
